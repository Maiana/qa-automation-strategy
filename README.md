...
- Scalable E2E and API automation
- Visual regression testing
- CI/CD integration
- Quality metrics and observability

This portfolio reflects not only automation skills but also **product-oriented quality thinking** and **strategic decision-making**.
...
| `api-tests/`           | API validation examples: CRUD, authentication, negative testing                                         |
| `visual-tests/`        | Visual regression examples: snapshot-based verification                                                 |
...
- **Type:** B2C E-commerce SaaS
- **Region:** European market
- **Release cadence:** Weekly
- **Critical flows:** Login, Checkout, Payment
- **Automation focus:** Risk-prioritized, business-impact-driven

> Note: Public demo sites are used as a simulation for showcasing QA strategies.
...
- Showcase **scalable, maintainable automation architecture**
- Provide **clear documentation for strategic decision-making**
- Illustrate **business-aligned QA prioritization**
